...
values (
  ...
  E'I''m an MCA student at Christ University, Bangalore (class of 2027), with a BCA from Chandigarh University.\n\nI work across the stack: React and Next.js on the frontend, Node.js/Express and SQL on the backend. Most of what I''ve shipped so far comes from building real things end to end — a movie catalog API with MySQL, a React app, and this portfolio itself (Next.js 15 + Supabase, with an admin dashboard and automated resume sync).\n\nI''m currently looking for SDE internship and new-grad roles for 2026–27.',
  'Bangalore, India',
